			...
			<div class="card-body">
				...
				foreach($edit_data as $row):
					...
					<div class="form-group">
						...
						<input type="email" class="form-control" name="email" value="<?php echo $row['email'];?>" readonly="true" required/>
					</div>
					...
					<div class="form-group">
						...
						<textarea rows="5" class="form-control" name="biography" placeholder="<?php echo get_phrase('biography'); ?>" ><?php echo $row['biography']; ?></textarea>
					</div>
