...
<form action="<?php echo site_url('admin/lessons/'.$param3.'/edit'.'/'.$param2); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" data-toggle="select2" name="lesson_type" id="lesson_type" required onchange="show_lesson_type_form(this.value)">
            ...
            <option value="text-field" <?php if($lesson_details['attachment_type'] == 'field') echo 'selected'; ?>><?php echo get_phrase('text_field'); ?></option>
    ...
    <div class="" id = "text" <?php if($lesson_details['lesson_type'] != 'text'):?> style="display: none;" <?php endif; ?>>
        <div class="form-group">
            <label> <?php echo get_phrase('translator_sentence'); ?></label>
            <div class="input-group">
                <input type="text" name ="translator_sentence" class="form-control" required value="<?php echo $lesson_details['translator_sentence']; ?>">
            </div>
            <label> <?php echo get_phrase('translated_sentence'); ?></label>
            <div class="input-group">
                <input type="text" name ="translated_sentence" class="form-control" required value="<?php echo $lesson_details['translated_sentence']; ?>">
            </div>
        </div>
    </div>
