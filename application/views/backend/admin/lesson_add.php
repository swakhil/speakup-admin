...
<form action="<?php echo site_url('admin/lessons/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" data-toggle="select2" name="lesson_type" id="lesson_type" required onchange="show_lesson_type_form(this.value)">
            ...
            <option value="text-field"><?php echo get_phrase('text_field'); ?></option>
    ...
    <div class="" id = "text" style="display: none;">
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" name ="translator_sentence" class="form-control" required>
            </div>
            <label> <?php echo get_phrase('translated_sentence'); ?></label>
            <div class="input-group">
                <input type="text" name ="translated_sentence" class="form-control" required>
            </div>
        </div>
    </div>
